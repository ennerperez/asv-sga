<form class="form-horizontal">
    ...
    <div class="form-group">
        <label class="col-md-2 control-label" for="textInput2">Nombre</label>
        <div class="col-md-6">
            <input type="text" id="textInput2" class="form-control">
        </div>
    </div>
     <div class="form-group">
        <label class="col-md-2 control-label" for="textInput5">Descripción</label>
        <div class="col-md-6">
            <input type="text" id="textInput5" class="form-control">
        </div>
    </div>
    <div class="form-group">
        <label class="col-md-2 control-label" for="boostrapSelect">Distrito</label>
        <div class="col-md-10">
    ...
    <div class="form-group">
        <label class="col-md-2 control-label" for="textInput4">Dirección</label>
        <div class="col-md-6">
