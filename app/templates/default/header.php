                ...
                switch (APPSTATE) {
                        ...
                        switch (ENVIRONMENT) {
                            case 'development':
                                Assets::css(array(
                                    ...
                                    Url::templatePath() . 'css/paper/bootstrap.css',
                                    Url::templatePath() . 'dataTables.bootstrap.css',
                                    Url::templatePath() . 'css/bootstrap-datepicker.css',
                            ...
                            default:
                                Assets::css(array(
                                    ...
                                    Url::templatePath() . 'css/paper/bootstrap.min.css',
                    ...
                    default:
                        switch (ENVIRONMENT) {
                            case 'development':
                                Assets::css(array(
									'http://fonts.googleapis.com/css?family=Ubuntu|Open+Sans',
                        ...
                        switch (ENVIRONMENT) {
                            ...
                            default:
                                Assets::js(array(
                                    ...
                                    Url::templatePath() . 'js/dataTables.bootstrap.min.js',
								    Url::templatePath() . 'js/jquery.bootstrap-autohidingnavbar.js',
                                    Url::templatePath() . 'js/bootlint.min.js',
                                    Url::templatePath() . 'js/scripts.js'
                                ));
                                break;
                        }
                        ...
                        switch (ENVIRONMENT) {
                            ...
                            default:
                                Assets::js(array(
                                    ...
                                    '//cdn.datatables.net/plug-ins/1.10.7/integration/bootstrap/3/dataTables.bootstrap.min.js',
								    Url::templatePath() . 'js/jquery.bootstrap-autohidingnavbar.js',
                                    '//maxcdn.bootstrapcdn.com/bootlint/0.12.0/bootlint.min.js',
                                    Url::templatePath() . 'js/scripts.js'
                                ));
                                break;
                        }
